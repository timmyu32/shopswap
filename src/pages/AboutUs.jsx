  ...
  return (
    <Flex direction='column'>
        ...
        <Flex direction='column' p={4}>
            <Text textAlign={'center'} fontSize={'4rem'} fontWeight={'800'}>About Us</Text>
            {!props.mobile?
            <Flex flex={1} p={6}>
                <Flex flex={1}>
                    <Flex direction='column' flex={1} alignItems={'center'} p={6} minW={'350px'}> 
                        <Image maxWidth={'60%'}src="./assets/images/IMG_5304.PNG"/>
                        <Text m='0 auto' fontWeight={'600'} mt={'27px'}>Mikayla Crowley</Text>
                ...
                <Flex flex={1}>
                    <Flex direction='column' flex={1} alignItems={'center'} p={6} minW={'350px'}>
                        <Image maxWidth={'60%'} src="./assets/images/IMG_5303.JPG"/>
                        <Text m='0 auto' fontWeight={'600'} mt={'10px'}>Katie Hill</Text>
            ...
            <Flex>
                <Flex direction='column' flex={1} alignItems={'center'} p={6} minW={'350px'}>
                    <Image maxWidth={'60%'} src="./assets/images/IMG_5346.JPG"/>
